...
module.exports = async function (deployer, network, accounts) {
  ...
  if (network !== "polygon") {
    ...
    if (network === "mumbai") {
      console.log("Deploy with NY on Mumbai...")
      // get existing contract of tier, level, and memories
      // const _propertyTierInstance = await PropertyTier.at("0x79A8471Ac9946bAa73A2945Ff2322Baa6Df77199");
      // const _propertyLevelInstance = await PropertyLevel.at("0xCCC56bC7fE2bF27D4434532E3Fae86E7f963d7A7");
      // const _memoriesInstance = await MetabloxMemories.at("0xFA1cDD02001E1043c0Cc67CA1a342ba7cfc2902f");
